...
public class CVUIBeanShell extends JPanel
{
     ...
     * Skript starten
     */
    private void processButtonRunScript()
    {
        this.lk_cBeanShell.runScript(this.lk_cBeanShellEditor.getScriptFile());
    ...
    {
    	this.lk_cErrorMessage.setShowWindow(bButtonState);
